      ...
      <div className="relative container mx-auto px-4 text-center">
        ...
        >
          ...
          <h2 className="font-display text-3xl md:text-4xl font-bold text-navy-foreground mb-4">
            Automatisez votre entreprise avec l'<span className="text-gradient">IA</span>
          </h2>
          <p className="text-navy-foreground/60 font-body text-lg mb-8">
            Découvrez comment notre agent IA peut transformer votre relation client et automatiser vos processus.
          </p>
